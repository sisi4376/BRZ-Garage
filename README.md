...
>
> ❗❗❗**若您愿意尝试BRZ Garage，请特别注意:**
> 
> ❌ **目前只支持MT版本，暂不支持AT版本**
>
> ❌ **目前仅针对ZD8开展了实车测试，ZC6尚未开展兼容测试，建议谨慎部署**
>
...
> 转速表和车速表运行时目前仍有一定的卡顿，高转速闪烁功能暂不可用
> 
...
✅ 保证持续记录（无需手机时刻在线，手机不在线也可以本地临时记录）

✅ 仪表功能拓展（功能性相比原生仪表大幅度提升）
...
- Waveshare ESP32-S3-Touch-AMOLED-1.75 或 1.75-B （**目前尚未开发GPS功能，如果希望保留GPS拓展，购买1.75-G版本**）；
- 一条确认支持数据传输的 USB 线；
- BLE ELM327 兼容适配器；
- Android 8.0+ 手机；
