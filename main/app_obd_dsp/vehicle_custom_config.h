...
static const vehicle_override_t s_vehicle_overrides[] = {
    {
        // Supported BRZ ZC6: one serial OBD/PID path, with Toyota Mode 21 oil temp.
        .match_name      = "ZC6",
    ...
    {
        // Keep the 0x241 decoder documented for a future direct-CAN/ASC build, but
        // do not attach it to the normal footwell-OBD ZD8 profile: Gen2's gateway
        // does not expose this broadcast to a regular ELM327 connection.
        .match_name      = "ZD8",
        .oil_primary     = &oil_std_5c,
        .forced_protocol = 6,
        .obd_timeout     = 0x0A,
