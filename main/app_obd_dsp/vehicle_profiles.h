...
typedef struct {
    ...
    bool obd_standard_gear_pid;          // query optional SAE J1979 PID 01 A4 and map its reported ratio to a forward gear
...
// Only the product-supported ZC6/ZD8 profiles may become active.
