...
extern lv_obj_t * ui_GearPageRpmText;
extern lv_obj_t * ui_GearPageRpmUnit;
extern lv_obj_t * ui_GearPageGearUnit;
...
extern lv_obj_t * ui_LabelEasterEggOdometer;
...
// SCREEN: fuel use (instant/current-trip/lifetime averages)
void ui_ScreenPageFuel_screen_init(void);
extern lv_obj_t *ui_ScreenPageFuel;
extern lv_obj_t *ui_LabelFuelInstant;
extern lv_obj_t *ui_LabelFuelInstantUnit;
extern lv_obj_t *ui_LabelFuelTripAverage;
extern lv_obj_t *ui_LabelFuelLifetimeAverage;
void ui_fuel_page_refresh(void);
void ui_event_fuel_background(lv_event_t *e);

// SCREEN: current-trip and lifetime totals
void ui_ScreenPageTripOverview_screen_init(void);
extern lv_obj_t *ui_ScreenPageTripOverview;
void ui_trip_overview_refresh(void);
void ui_event_trip_overview_background(lv_event_t *e);

// SCREEN: since-refuel and phone-defined custom trip totals
void ui_ScreenPageTripIntervals_screen_init(void);
extern lv_obj_t *ui_ScreenPageTripIntervals;
void ui_trip_intervals_refresh(void);
void ui_event_trip_intervals_background(lv_event_t *e);

// SCREEN: completed ignition-trip history (newest four shown)
void ui_ScreenPageTripHistory_screen_init(void);
extern lv_obj_t *ui_ScreenPageTripHistory;
void ui_trip_history_refresh(void);
void ui_trip_history_page(int delta);       // +1 older page, -1 newer page
...
LV_IMG_DECLARE(pngLogoSTI);           // STI wordmark used by boot + device-info pages
