...
// Outer bezel ring (456x456 on the 466x466 AMOLED, centered, static circular
// border; replaces the
...
lv_obj_t * ui_helpers_create_ring(lv_obj_t * parent, uint8_t border_width)
{
    ...
    // Leave only a 5 px hardware-safe margin. The old 360 px ring discarded
    // too much of the round panel's usable area and clipped wide information.
