...
#define RPM_REDLINE      7000   // fixed red zone threshold
#define RPM_DIAL_MAX     9000   // full-scale value of the combined RPM dial
#define SWEEP_SPEED_PEAK 999    // sweep peak speed
#define SPEED_DIAL_MAX 240      // speed dial full scale (km/h)
